...
console.log("Oh Dear, I only can invite 2 people because of space");
let lastIndex = guestList.length - 1;
do {
    if(lastIndex >= 2) {
        let gusetName = guestList[lastIndex];
        guestList.pop();
        console.log(`I'm sorry ${gusetName}, I can't invite you to dinner.`);
        lastIndex--;
    }
}while (lastIndex >= 2);
